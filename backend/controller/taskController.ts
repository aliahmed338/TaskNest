...
import { IdParam, ITask } from "../types/task";
...
export const getAllTasks = catchAsyncError(
  async (req: Request<{}, {}, {}>, res: Response, next: NextFunction) => {
    ...
    const filteredTasks = apiFilter.tasks;
    ...
    if (apiFilter.grouped) {
      responseData.grouped = apiFilter.grouped;
    }
 ...
 * @route  PATCH /api/v1/task/:id/archive
 * @access Private
 */
 ...
 * @route  PATCH /api/v1/task/:id/unarchive
 * @access Private
 */
